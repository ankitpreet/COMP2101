...
echo "Invalid option found. Please use -help to get more information about usage."
}
...
function error-exit {
#exit is not a viable option here. exit 1 is not good.
...
echo "Use this informations to use as an input with this script"
echo '$0 [-h] [--help] [--domain] [--ipconfig] [--host] [--os] [--memory] [--cpu] [--disk] [--printer]'
}
...
function cleanup {
	rm -rf /tmp/*info*
	echo "trap execution completed successfullly."
}
#trap cleanup SIGINT
